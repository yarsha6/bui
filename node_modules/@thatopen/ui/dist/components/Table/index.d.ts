...
import { TableDefinition, TableGroupData, TableRowData, TableRowTemplate } from "./src";
...
export declare class Table extends LitElement {
    ...
    setIndentationColor(indentationLevel: number, color: string): void;
    /**
